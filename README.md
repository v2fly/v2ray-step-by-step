...
感谢 [ToutyRater](https://github.com/ToutyRater) 最初撰写了这份指南，帮助了无数人跨越长城走向世界。

现在 [原始指南](https://github.com/ToutyRater/v2ray-guide) 将交由 V2Fly 社区继续维护，欢迎任何形式贡献，分享你的经验和配置或者是勘误/翻译等等。

目前指南使用 [BY-CC 4.0](https://github.com/v2fly/v2ray-step-by-step/blob/master/LICENSE.md) 授权协议。
...
**本指南的目标用户是有一定的 Linux 操作基础，像怎么注册 VPS，怎么用 SSH 登录 VPS，怎么使用 nano（或 vi/vim）编辑一个文本以及一些 Linux 基本命令的使用······网上有一大堆的指南，没必要重复造轮子再写一篇教程，如果这些你不会，强烈建议你去学会了再来尝试搭建 V2Ray。**
